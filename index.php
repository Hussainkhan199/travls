			...
			<div class="container">
				...
				<div class="upper">
					...
					<div class="col-sm-2">
						<div class="logo">
							<a href="index.php">
								<img src="assets/logo/logo_1.png" alt="logo" width="100" />
							</a>
						</div><!-- /.logo-->
						<div class="media">
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="single-about-us">
							<div class="about-us-txt" style="margin-top:50px;">
								<h2 style="font-size:60px;">
									Embrace the Unknown <span style="color: #df9023;font-size:80px;"> Embrace the Adventure </span>
									...
									<form action="" method="post" class="form-inline" autocomplete="on" id="ticketForm">
										<div id="step1" class="form-group">
											...
											<div class="step_1">
												...
												<input type="select" placeholder="From" id="from" name="arrival" list="list" style="width: 20%;
												...
												<input type="select" placeholder="TO" id="to" name="desti" list="list_2" style="width: 20%;
																display: inline-block;
																/* width: auto; */
																padding: 8px;
																margin-bottom: 10px;
