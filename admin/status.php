        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="user_for_other_admins.php" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
...
if(isset($_POST['submit']) && isset($_GET['id'])) {
    ...
    $query = "UPDATE tickets SET status = '$status' WHERE id = '$data'";
...
<form action="" method="post">
    <div class="form-group">
        <label for="status">assign_to:</label>
        <!-- <input type="date" class="form-control"  name="from" id="from"> -->
		<select name="status" id="assign_to" aria-placeholder="assign to agent">
